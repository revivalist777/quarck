...
In order to support loading of multiple wallets in alp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is alp.cpp.
...
Changes to alp.cpp
----------------------
alp.cpp is the entry point into alp-qt, and as such, will require some minor modifications to provide hooks for
