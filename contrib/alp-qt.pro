...
RESOURCES += src/qt/alp.qrc src/qt/alp_locale.qrc

TRANSLATIONS += src/qt/locale/alp_bg.ts \
                src/qt/locale/alp_de.ts \
                src/qt/locale/alp_en.ts \
                src/qt/locale/alp_es.ts \
                src/qt/locale/alp_fi.ts \
                src/qt/locale/alp_fr.ts \
                src/qt/locale/alp_it.ts \
                src/qt/locale/alp_ja.ts \
                src/qt/locale/alp_pl.ts \
                src/qt/locale/alp_pt.ts \
                src/qt/locale/alp_ru.ts \
                src/qt/locale/alp_sk.ts \
                src/qt/locale/alp_sv.ts \
                src/qt/locale/alp_vi.ts \
                src/qt/locale/alp_zh_CN.ts \
                src/qt/locale/alp_zh_TW.ts
