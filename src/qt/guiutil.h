...
/** Utility functions used by the AlphaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render AlphaCoin addresses in monospace font
...
// Parse "alp:" URI into recipient object, return true on successful parsing
