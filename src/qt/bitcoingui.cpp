                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AlphaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AlphaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alp: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AlphaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about AlphaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AlphaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AlphaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AlphaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a AlphaCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AlphaCoin Core help message to get a list with possible AlphaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AlphaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AlphaCoin network", "", count));
}
...
{
    QString strTitle = tr("AlphaCoin Core"); // default title
