Contributing to AlphaCoin Core
============================

The AlphaCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AlphaCoin Core project, and is not to be
confused with overall ALP Network Protocol consensus changes.

Whether a pull request is merged into AlphaCoin Core rests with the project merge
...
Patches that change ALP consensus rules are considerably more involved than
...
Where a patch set proposes to change the ALP consensus, it must have been
...
The project leader is the release manager for each AlphaCoin Core release.
